...
public class PemesananController extends Controller implements Initializable {
    private static Ruangan selected; // Form
    ...
    @FXML
    private void cekRuangAction (ActionEvent e) {
        Ruangan tmp = cbRuangan.getSelectionModel().getSelectedItem();
        Alert alert = new Alert(AlertType.INFORMATION);
        alert.setTitle(tmp.getNama());
        alert.setContentText(tmp.getFasilitas());
        alert.show();
    }
    ...
    private void bookingAction (ActionEvent e) {
        ...
        LocalDateTime akhir = LocalDateTime.of(waktuAkhir, LocalTime.of(Integer.parseInt(cbJamAkhir.getValue()), 0));
        ...
        alert.setContentText("Pemesanan berhasil dilakukan, mohon tunggu admin untuk mengkonfirmasi");
        alert.showAndWait();
        try {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        dbRuangan.get().forEach((r) -> listRuangan.add(r));
